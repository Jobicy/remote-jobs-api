...
description: Search and discover remote job opportunities using the Jobicy Jobs API and MCP server. Use when an agent needs to find, filter, compare, or retrieve current remote job listings.
---
